...
// One common use case for this is if you wish to issue multiple requests on page load (or some other event) and only 
// want to take action when a response has been received for all.
const { ajax } = require('rxjs/ajax');
const { forkJoin,  interval, of } = require('rxjs');
